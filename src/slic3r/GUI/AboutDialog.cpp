        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER)
{
    ...
    m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_AUTO/*NEVER*/);
    {
        ...
        const std::string based_on_str = _utf8(L("SliCR-3D is a skinned version of Slic3r, based on PrusaSlicer by Prusa, SuperSlicer by merill and the original Slic3r by Alessandro Ranellucci & the RepRap community."));
